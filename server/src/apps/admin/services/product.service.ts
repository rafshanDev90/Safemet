...
const store = new JsonStore<Product>('products');
...
export class ProductService {
  ...
  static findPaginated(query: PaginationQuery): PaginatedResult<Product> {
  ...
  static update(id: string, input: UpdateProductInput): Product | undefined {
