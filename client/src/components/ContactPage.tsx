        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-8 flex flex-col">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#111827] tracking-tight mb-8">
                Get in Touch
              </h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                    <div>
                      <input
                        ...
                        className="w-full bg-white text-neutral-800 placeholder:text-neutral-500 px-4 py-3.5 text-xs sm:text-sm border border-neutral-300 focus:outline-none focus:border-[#E5252B] focus:ring-1 focus:ring-[#E5252B] transition-all"
                      />
                    </div>
                    <div>
                      <input
                  ...
                  <div className="pt-2">
                    <button
                      ...
                      className="bg-[#C22126] hover:bg-[#a51a1e] text-white font-extrabold text-xs sm:text-sm tracking-widest uppercase px-10 py-3.5 transition-colors duration-200 cursor-pointer shadow-sm"
                    >
                      CONTACT US
                    </button>
                  </div>
            ...
            <div className="lg:col-span-4 flex flex-col space-y-8 lg:pl-6">
              ...
              <div className="space-y-3 pb-6 border-b border-neutral-200">
                <h3 className="text-xs sm:text-[13px] font-extrabold uppercase tracking-wider text-neutral-900">
                  GET SOCIAL
                </h3>
