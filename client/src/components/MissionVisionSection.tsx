...
export const MissionVisionSection: React.FC = () => {
  return (
    <section id="mission-vision" className="w-full bg-white py-12 md:py-16">
      <Container>
        {/* Section Header */}
        <div className="flex items-center gap-4 pb-6 mb-10 border-b border-neutral-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 mb-14 lg:mb-16">
          {/* Mission Card */}
          <div className="bg-[#f4f5f6] border-l-4 border-[#E5252B] p-6 sm:p-8">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-full bg-[#fde8e9] border border-[#f8b4b7] flex items-center justify-center">
                <Target className="w-5 h-5 text-[#E5252B]" />
              </div>
              <h3 className="text-sm sm:text-base font-extrabold uppercase tracking-wider text-[#1e2327] font-['Montserrat',sans-serif]">
                OUR MISSION
              </h3>
            </div>
          ...
          <div className="bg-[#f4f5f6] border-l-4 border-[#E5252B] p-6 sm:p-8">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-full bg-[#fde8e9] border border-[#f8b4b7] flex items-center justify-center">
                <Eye className="w-5 h-5 text-[#E5252B]" />
              </div>
              <h3 className="text-sm sm:text-base font-extrabold uppercase tracking-wider text-[#1e2327] font-['Montserrat',sans-serif]">
                OUR VISION
              </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-10 items-center mb-14 lg:mb-16">
          {/* Headshot */}
          <div className="md:col-span-4 flex justify-center md:justify-start">
            <div className="w-52 h-52 sm:w-60 sm:h-60 bg-white p-2 shadow-md border border-neutral-200 overflow-hidden flex items-center justify-center">
              <img
          ...
          <div className="md:col-span-8">
            <div className="flex items-center gap-2 mb-3">
              <Quote className="w-4 h-4 text-[#E5252B]" />
              <span className="text-[11px] font-bold tracking-[0.25em] text-[#E5252B] uppercase font-['Montserrat',sans-serif]">
            ...
            <div className="pt-4 border-t border-neutral-200">
              <p className="text-sm font-extrabold text-[#1e2327] uppercase tracking-wider font-['Montserrat',sans-serif]">
