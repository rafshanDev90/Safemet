...
export const ProjectsSection: React.FC = () => {
  ...
  return (
    <section id="projects" className="w-full bg-[#f4f5f6] py-12 md:py-16">
      <Container>
        {/* Section Header */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-6 mb-8 border-b border-neutral-300 gap-2">
          ...
          <span className="text-xs text-neutral-500 font-semibold tracking-wider uppercase hidden sm:inline-block">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/85 via-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-5 text-white">
                <span className="text-[10px] font-bold tracking-widest text-[#E5252B] uppercase mb-1 flex items-center gap-1">
                  <Building className="w-3 h-3" /> {proj.category}
                </span>
                <h4 className="text-sm font-bold leading-tight uppercase font-['Montserrat',sans-serif]">
                  {proj.title}
                </h4>
                <div className="flex items-center justify-between mt-2 pt-2 border-t border-white/20 text-neutral-300 text-xs">
              ...
              <div className="absolute top-2.5 right-2.5 bg-black/40 text-white/90 text-[10px] font-mono px-1.5 py-0.5 rounded-xs backdrop-blur-xs opacity-60 group-hover:opacity-100 transition-opacity">
